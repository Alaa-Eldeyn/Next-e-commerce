...
const CheckoutForm = ({ amount }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-[450px] mx-auto mt-20">
      <PaymentElement />
      <button
        className="inline-block rounded border w-full mt-5 border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
        type="submit"
